...
<table border=0> 
  <td width="550px"><i><a href="?pg=tambah_fasilitaskamar" class="btn btn-success"><i class="fa fa-plus">Tambah Fasilitas Kamar</a></i> </td>
  <td>
    <form method="POST">

        <label><i> Pencarian Data : </i> </label>
        <input type="text" name="nama" placeholder="cari tipe kamar" >
      </td>
      <td>
